...
/*******************************************************************************
* Function Name  : Standard_GetMidiInterface
* Input          : Length - How many bytes are needed.
* Output         : None.
* Return         : Return "Buffer"
*******************************************************************************/
uint8_t *Standard_GetMidiInterface(uint16_t Length)
{
  ...
  ONE_DESCRIPTOR desc = {(uint8_t *)midi_indicator, 128};
...
void Data_Setup0(void)
{
  ...
  else if ((Request_No == 0x55) && (pInformation->USBwValue == 0)
           && (pInformation->USBwLength == 0x0080)) {
    CopyRoutine = Standard_GetMidiInterface;
  }
